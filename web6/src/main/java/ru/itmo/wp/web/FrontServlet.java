...
//        putUser(request, view);
        ...
        try {
            ...
            Method method1 = pageClass.getDeclaredMethod("before", HttpServletRequest.class, Map.class);
            method1.invoke(page, request, view);
            method.invoke(page, request, view);
            Method method2 = pageClass.getDeclaredMethod("after", HttpServletRequest.class, Map.class);
            method2.invoke(page, request, view);
